...
const midjourneyConfig: SiteConfig = {
  ...
  // ⚠️ bot対策(403 Forbidden)により安定して取得できないため手動確認待ちとする。
  skipFetch: true,
  category: "image",
  parse(html) {
    return [
      ...
      { planName: "Mega", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
    ];
  },
};
...
const leonardoConfig: SiteConfig = {
  ...
  parse(html) {
    return [
      ...
      { planName: "Essential", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      ...
      { planName: "Ultimate", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
...
// ============================================================
// 動画生成AI (category: "video")
// ============================================================

const runwayConfig: SiteConfig = {
  slug: "runway",
  displayName: "Runway",
  ...
  parse(html) {
    return [
      ...
      { planName: "Standard", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Pro", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Unlimited", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
    ];
  },
};

// ------------------------------------------------------------
// OpenAI Sora: 個人向け単体サービスは2026年4月26日に提供終了。
// 現在はAPI従量課金のみ(業界再編の一例として記録しておく)。
// ------------------------------------------------------------
const openaiSoraConfig: SiteConfig = {
  slug: "openai-sora",
  displayName: "OpenAI Sora",
  officialSite: "https://openai.com/sora",
...
const googleVeoConfig: SiteConfig = {
  slug: "google-veo",
  displayName: "Google Veo (Gemini内蔵)",
  officialSite: "https://gemini.google",
  sourceUrl: "https://gemini.google/subscriptions/",
  skipFetch: true,
  category: "video",
...
const grokImagineVideoConfig: SiteConfig = {
  slug: "grok-imagine-video",
  displayName: "Grok Imagine 動画 (xAI)",
  officialSite: "https://grok.com",
  sourceUrl: "https://x.ai/grok",
  skipFetch: true,
  category: "video",
...
const klingAIConfig: SiteConfig = {
  slug: "kling-ai",
  displayName: "Kling AI (快手)",
  officialSite: "https://klingai.com",
  sourceUrl: "https://klingai.com/pricing",
  skipFetch: true,
  category: "video",
  parse(html) {
    return [
      ...
      { planName: "Standard", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Pro", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Premier", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
    ];
  },
};

const lumaAIConfig: SiteConfig = {
  slug: "luma-ai",
  displayName: "Luma AI (Dream Machine)",
  officialSite: "https://lumalabs.ai",
  sourceUrl: "https://lumalabs.ai/dream-machine/pricing",
  skipFetch: true,
  category: "video",
  parse(html) {
    return [
      ...
      { planName: "Plus", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Pro", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Ultra", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Enterprise", rawPriceText: "Custom", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "custom", audience: "enterprise" },
    ];
  },
};

const pikaConfig: SiteConfig = {
  slug: "pika",
  displayName: "Pika",
  officialSite: "https://pika.art",
  ...
  parse(html) {
    return [
      ...
      { planName: "Standard", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Pro", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Fancy", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
    ];
  },
};

// ------------------------------------------------------------
// ByteDance (Seedance/即梦): 統一されたサブスクプランが無く、
// 自社アプリ(Dreamina/即梦)やAPI経由での利用が中心。
// ------------------------------------------------------------
const bytedanceSeedanceConfig: SiteConfig = {
  slug: "bytedance-seedance",
  displayName: "ByteDance (Seedance/即梦)",
  officialSite: "https://jimeng.jianying.com",
  ...
  parse(html) {
    return [
      {
        planName: "Free (Dreamina/即梦アプリ、制限付き)",
        rawPriceText: "Free",
        basePriceAmount: 0,
        billingPeriod: "monthly",
        priceBasis: "flat",
...
// ------------------------------------------------------------
// Alibaba (Wan): オープンモデル配布が中心で、統一サブスクが無い。
// ------------------------------------------------------------
const alibabaWanConfig: SiteConfig = {
  slug: "alibaba-wan",
  displayName: "Alibaba (Wan)",
  officialSite: "https://tongyi.aliyun.com/wanxiang/",
...
const minimaxHailuoConfig: SiteConfig = {
  slug: "minimax-hailuo",
  displayName: "MiniMax (Hailuo)",
  officialSite: "https://hailuoai.video",
  sourceUrl: "https://hailuoai.video/pricing",
  skipFetch: true,
  category: "video",
  parse(html) {
    return [
...
const heygenConfig: SiteConfig = {
  slug: "heygen",
  displayName: "HeyGen",
  officialSite: "https://www.heygen.com",
  ...
  parse(html) {
    return [
      { planName: "Free", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Creator", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Pro", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Business", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "custom", audience: "team" },
      { planName: "Enterprise", rawPriceText: "Custom", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "custom", audience: "enterprise" },
    ];
...
const synthesiaConfig: SiteConfig = {
  slug: "synthesia",
  displayName: "Synthesia",
  officialSite: "https://www.synthesia.io",
  ...
  parse(html) {
    return [
      { planName: "Free", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Starter", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Creator", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Enterprise", rawPriceText: "Custom", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "custom", audience: "enterprise" },
    ];
  },
...
// ------------------------------------------------------------
// Vidu (生数科技): 信頼できる価格情報が集まっていないため、
// 全プラン空欄で登録し、後日確認する。
// ------------------------------------------------------------
const viduConfig: SiteConfig = {
  slug: "vidu",
  displayName: "Vidu (生数科技)",
  officialSite: "https://www.vidu.com",
  sourceUrl: "https://www.vidu.com/pricing",
  skipFetch: true,
  category: "video",
  parse(html) {
    return [
...
// ------------------------------------------------------------
// Higgsfield: 複数モデルを束ねるクレジット制のため、
// 大部分が確度不足。全プラン空欄で登録し、後日確認する。
// ------------------------------------------------------------
const higgsfieldConfig: SiteConfig = {
  slug: "higgsfield",
...
// ============================================================
// 音楽生成AI (category: "music")
// ============================================================

const sunoConfig: SiteConfig = {
  slug: "suno",
  displayName: "Suno",
  officialSite: "https://suno.com",
...
// ------------------------------------------------------------
// Udio: 2025年10月29日よりUMGとの提携再構築のためダウンロード機能を
// 一時停止中(業界再編・法的整理の一例として記録しておく)。
// ------------------------------------------------------------
const udioConfig: SiteConfig = {
  slug: "udio",
  displayName: "Udio",
  officialSite: "https://www.udio.com",
...
const elevenMusicConfig: SiteConfig = {
  slug: "eleven-music",
  displayName: "ElevenMusic (ElevenLabs)",
...
const stableAudioConfig: SiteConfig = {
  slug: "stable-audio",
  displayName: "Stable Audio (Stability AI)",
  officialSite: "https://stableaudio.com",
  sourceUrl: "https://stableaudio.com/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
      { planName: "Free", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Studio", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
    ];
  },
};

const googleLyriaConfig: SiteConfig = {
  slug: "google-lyria",
  displayName: "Google Lyria (Gemini内蔵)",
  officialSite: "https://gemini.google",
  sourceUrl: "https://gemini.google/subscriptions/",
  skipFetch: true,
  category: "music",
...
const murekaConfig: SiteConfig = {
  slug: "mureka",
  displayName: "Mureka",
  officialSite: "https://www.mureka.ai",
  sourceUrl: "https://www.mureka.ai/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
// ------------------------------------------------------------
// AIVA: ユーロ建て。基軸通貨(USD)との単純な数値比較ができないため、
// 金額は空欄(rawPriceTextのみ)で扱う。
// ------------------------------------------------------------
const aivaConfig: SiteConfig = {
  slug: "aiva",
  displayName: "AIVA",
  officialSite: "https://www.aiva.ai",
  sourceUrl: "https://www.aiva.ai/plans",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
      { planName: "Free", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Standard", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "custom", audience: "individual" },
      { planName: "Pro", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "custom", audience: "individual" },
    ];
  },
};

const boomyConfig: SiteConfig = {
  slug: "boomy",
  displayName: "Boomy",
  officialSite: "https://boomy.com",
  sourceUrl: "https://boomy.com/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
const soundrawConfig: SiteConfig = {
  slug: "soundraw",
  displayName: "Soundraw",
  officialSite: "https://soundraw.io",
  sourceUrl: "https://soundraw.io/plans",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
      { planName: "Creator", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
      { planName: "Artist", rawPriceText: "MANUAL_ENTRY_REQUIRED", basePriceAmount: null, billingPeriod: "monthly", priceBasis: "flat", audience: "individual" },
    ];
  },
};

const mubertConfig: SiteConfig = {
  slug: "mubert",
  displayName: "Mubert",
  officialSite: "https://mubert.com",
  sourceUrl: "https://mubert.com/render/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
const loudlyConfig: SiteConfig = {
  slug: "loudly",
  displayName: "Loudly",
  officialSite: "https://www.loudly.com",
  sourceUrl: "https://www.loudly.com/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
const beatovenConfig: SiteConfig = {
  slug: "beatoven-ai",
  displayName: "Beatoven.ai",
  officialSite: "https://www.beatoven.ai",
  sourceUrl: "https://www.beatoven.ai/pricing/",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
const musicfyConfig: SiteConfig = {
  slug: "musicfy",
  displayName: "Musicfy",
  officialSite: "https://www.musicfy.lol",
  sourceUrl: "https://www.musicfy.lol/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
const riffusionConfig: SiteConfig = {
  slug: "riffusion",
  displayName: "Riffusion",
  officialSite: "https://www.riffusion.com",
  sourceUrl: "https://www.riffusion.com/pricing",
  skipFetch: true,
  category: "music",
  parse(html) {
    return [
...
const SITES: SiteConfig[] = [
  ...
  openaiSoraConfig,
  googleVeoConfig,
  grokImagineVideoConfig,
  klingAIConfig,
  lumaAIConfig,
  pikaConfig,
  bytedanceSeedanceConfig,
  alibabaWanConfig,
  minimaxHailuoConfig,
  heygenConfig,
  synthesiaConfig,
